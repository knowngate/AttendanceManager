...
namespace NFCCS {
    ...
    public class stdinforpt : ReportClass {
    ...
    public class Cachedstdinforpt : Component, ICachedReport {
        
        public Cachedstdinforpt() {
        }
